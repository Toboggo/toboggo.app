...
import { listParksByIds, formatDistance, formatAgeRange, AGE_UNKNOWN_LABEL, haversineMeters } from "@toboggo/shared";
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 480 }}>
          ...
          <tbody>
            ...
            <tr>
              ...
              {parks.map((p) => (
                <td key={p.id} style={{ padding: 8, fontSize: 13 }}>
                  {formatAgeRange(p.age_min, p.age_max) ?? AGE_UNKNOWN_LABEL}
                </td>
              ))}
            </tr>
            <tr>
